...
export function ChatListItem({ item, isSelected, onClick }: ChatListItemProps) {
    return (
        <button
            className={cn(
                "flex flex-col items-start gap-2 rounded-lg border p-3 text-left text-sm transition-all hover:bg-accent shrink-0",
                isSelected && "bg-muted"
            )}
